...
# Set data
df = pd.DataFrame({
    'name': ['barra de gramame','Nova conquista Taquara','Vitória','Bernardo Severo'],
    'medicina indigena':  [2, 25,2,10],
    'parteiras': [1, 5,4,20],
    'rezadeiras/ benzedoras':  [8, 2,3,50],
    'Simbolo de proteção': [13,14,0,6],
    'valorizacao da oralidade e saberes ancestrais':  [3, 3,5],
    'valorizacao dos sinais da natureza': [5, 1,8]})
