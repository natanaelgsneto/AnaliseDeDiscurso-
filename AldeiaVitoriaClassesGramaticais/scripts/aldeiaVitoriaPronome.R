...
# Definir uma lista de pronomes
pronomes <- c("eu", "tu", "ele", "ela", "nós", "vós", "eles", "elas", 
              "meu", "minha", "meus", "minhas", "teu", "tua", "teus", "tuas", 
              "seu", "sua", "seus", "suas", "nosso", "nossa", "nossos", "nossas",
              "vosso", "vossa", "vossos", "vossas", "me", "te", "se", "nos", "vos")
...
# Contar os pronomes
contagem_pronomes <- table(palavras[palavras %in% pronomes])

# Exibir o resultado
print(contagem_pronomes)


write.table(x = contagem_pronomes,
            file = "pronomesAldeiaVitoria.txt",  # Save the file as pirates.txt to my desktop
            sep = "\t")   
