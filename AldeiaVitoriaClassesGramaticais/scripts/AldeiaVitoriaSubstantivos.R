...
# Filtrar apenas os substantivos
substantivos <- anotacao[anotacao$upos == "NOUN", ]

# Contar os substantivos
contagem_substantivos <- table(substantivos$lemma)

# Mostrar a contagem
print(contagem_substantivos)

t(contagem_substantivos)

write.table(x = contagem_substantivos,
            file = "AldeiaVitoria_SUBSTANTIVOS.txt",  # Save the file as pirates.txt to my desktop
            sep = "\t")  